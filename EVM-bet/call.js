...
const lotteryCA = "0xC1D2eB15b09dE06d1c70559963B731D2f2965d82"; // "0x68B5E924DDDdA92dEA7F38f8dCB3386d4854c18F";
const randomizerCA = "0xC670060dED5057fBeC4D55cCd4446901A3E6E3f0"; // "0x8b657bdbb185F7921d6bE08032Ac2ce2039a8481";

const prov =
  /* "https://testnet-rpc.mainnetz.io"; // */ "https://node.ghostnet.etherlink.com";
...
//   console.log("address: ", wallet.address);
  ...
  const callbackGasLimit = BigInt(15000000);
  ...
  try {
    ...
    const res3 = await newRoundTx.wait();
